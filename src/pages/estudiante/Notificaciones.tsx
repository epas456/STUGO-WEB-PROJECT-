...
import { Bell, CheckCheck, Zap, Star, CreditCard, Calendar, MessageSquare } from 'lucide-react'
...
const ICONS: Record<string, React.ElementType> = { pago: CreditCard, turno: Calendar, mensaje: MessageSquare, valoracion: Star, oportunidad: Zap }
const COLORS: Record<string, string> = { pago: 'var(--success)', turno: 'var(--info)', mensaje: 'var(--info)', valoracion: 'var(--warning)', oportunidad: 'var(--danger)' }
