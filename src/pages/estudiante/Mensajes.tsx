        ...
        <div className="flex-1 overflow-y-auto">
          {conversaciones.map((conv) => {
            ...
            return (
              ...
              >
                <AvatarCircle name={conv.empresaNombre} size={42} />
      ...
      {activeConv ? (
        ...
        >
          ...
          >
            ...
            <AvatarCircle name={activeConv.empresaNombre} size={40} />
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-[var(--text-primary)] text-sm">
                {activeConv.empresaNombre}
              </p>
              {activeConv.turnoTitulo && (
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {allMessages.map((msg) => {
              const isMine = msg.autorRol === 'estudiante'
              return (
            ...
            {typing && (
              <div className="flex justify-start">
                <AvatarCircle name={activeConv.empresaNombre} size={28} />
                <div
        ...
        <div className="hidden sm:flex flex-1 items-center justify-center flex-col gap-3">
          ...
          >
            <Send size={24} style={{ color: 'var(--text-secondary)' }} />
          </div>
